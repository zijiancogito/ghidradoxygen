\hypertarget{class_pcode_inject_library}{}\section{Pcode\+Inject\+Library Class Reference}
\label{class_pcode_inject_library}\index{PcodeInjectLibrary@{PcodeInjectLibrary}}
...
This is a container of \mbox{\hyperlink{class_inject_payload}{Inject\+Payload}} objects that can be applied for a specific \mbox{\hyperlink{class_architecture}{Architecture}}. Payloads can be read in via X\+ML (\mbox{\hyperlink{class_pcode_inject_library_a738666065a924346cf552b1d62c84848}{restore\+Xml\+Inject()}}) and manually via \mbox{\hyperlink{class_pcode_inject_library_a0e360443cbc6ff94ea71d197882c55a8}{manual\+Call\+Fixup()}} and \mbox{\hyperlink{class_pcode_inject_library_a93f4e4b0f75d81b96bd92623d392269a}{manual\+Call\+Other\+Fixup()}}. Each payload is assigned an integer {\itshape id} when it is read in, and \mbox{\hyperlink{class_pcode_inject_library_a6075295c64a06ab05e954dc6f18945f9}{get\+Payload()}} fetches the payload during analysis. The library also associates the formal names of payloads with the id. Payloads of different types, C\+A\+L\+L\+F\+I\+X\+U\+P\+\_\+\+T\+Y\+PE, C\+A\+L\+L\+O\+T\+H\+E\+R\+F\+I\+X\+U\+P\+\_\+\+T\+Y\+PE, etc., are stored in separate namespaces.
...
\mbox{\Hypertarget{class_pcode_inject_library_a13fae9d7af655217a5612e4837d1f269}\label{class_pcode_inject_library_a13fae9d7af655217a5612e4837d1f269}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!PcodeInjectLibrary@{PcodeInjectLibrary}}
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\mbox{\Hypertarget{class_pcode_inject_library_ae7a4417915e073736f49f698b95eb450}\label{class_pcode_inject_library_ae7a4417915e073736f49f698b95eb450}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!````~PcodeInjectLibrary@{$\sim$PcodeInjectLibrary}}
\index{````~PcodeInjectLibrary@{$\sim$PcodeInjectLibrary}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\mbox{\Hypertarget{class_pcode_inject_library_a386a617992fcdd31d9abbf0728126686}\label{class_pcode_inject_library_a386a617992fcdd31d9abbf0728126686}} 
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_aa2c520dab5db72d968e383b56d1ea8f6}\label{class_pcode_inject_library_aa2c520dab5db72d968e383b56d1ea8f6}} 
...
\mbox{\Hypertarget{class_pcode_inject_library_a3a1ca9f7ea2cea02de1141cc35c79b18}\label{class_pcode_inject_library_a3a1ca9f7ea2cea02de1141cc35c79b18}} 
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_a436ac8db6c2f5735481c86a937d3db55}\label{class_pcode_inject_library_a436ac8db6c2f5735481c86a937d3db55}} 
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_aaf5cb3c65ea01b0db1d38777f23b8796}\label{class_pcode_inject_library_aaf5cb3c65ea01b0db1d38777f23b8796}} 
...
\subsubsection{\texorpdfstring{getCallMechanismName()}{getCallMechanismName()}}
...
\mbox{\Hypertarget{class_pcode_inject_library_a928588313e2dfb9454b65f932985d97c}\label{class_pcode_inject_library_a928588313e2dfb9454b65f932985d97c}} 
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_a6075295c64a06ab05e954dc6f18945f9}\label{class_pcode_inject_library_a6075295c64a06ab05e954dc6f18945f9}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!getPayload@{getPayload}}
\index{getPayload@{getPayload}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_ad49624d6aa508e6e75d7c23f9c839c02}\label{class_pcode_inject_library_ad49624d6aa508e6e75d7c23f9c839c02}} 
...
\subsubsection{\texorpdfstring{getPayloadId()}{getPayloadId()}}
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_a6ec47b3f3836fdd9116a9755ad1727c4}\label{class_pcode_inject_library_a6ec47b3f3836fdd9116a9755ad1727c4}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!getUniqueBase@{getUniqueBase}}
\index{getUniqueBase@{getUniqueBase}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\mbox{\Hypertarget{class_pcode_inject_library_a0e360443cbc6ff94ea71d197882c55a8}\label{class_pcode_inject_library_a0e360443cbc6ff94ea71d197882c55a8}} 
...
Implemented in \mbox{\hyperlink{class_pcode_inject_library_sleigh_a4cce009469fb3679881ea73bc2ed9284}{Pcode\+Inject\+Library\+Sleigh}}, and \mbox{\hyperlink{class_pcode_inject_library_ghidra_a2e8265c935ddb94e4a2354706d823e14}{Pcode\+Inject\+Library\+Ghidra}}.

\mbox{\Hypertarget{class_pcode_inject_library_a93f4e4b0f75d81b96bd92623d392269a}\label{class_pcode_inject_library_a93f4e4b0f75d81b96bd92623d392269a}} 
...
Implemented in \mbox{\hyperlink{class_pcode_inject_library_sleigh_a5effe6ebe2d5b20644c2066d427283ae}{Pcode\+Inject\+Library\+Sleigh}}, and \mbox{\hyperlink{class_pcode_inject_library_ghidra_a1c38e037571239e59daa21c08f2a2bbb}{Pcode\+Inject\+Library\+Ghidra}}.
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_a2c6c5deb054a7ab6f8e59653ce9d984f}\label{class_pcode_inject_library_a2c6c5deb054a7ab6f8e59653ce9d984f}} 
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_a8e767c1d87d0cfabac0341c35c188b88}\label{class_pcode_inject_library_a8e767c1d87d0cfabac0341c35c188b88}} 
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_aa06eaa0357d6aeed80a3f64a5e914a53}\label{class_pcode_inject_library_aa06eaa0357d6aeed80a3f64a5e914a53}} 
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_a73430017e8dc38985a1e20196e59eb85}\label{class_pcode_inject_library_a73430017e8dc38985a1e20196e59eb85}} 
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_a0b75b562fb736f23269114fec5ca36d9}\label{class_pcode_inject_library_a0b75b562fb736f23269114fec5ca36d9}} 
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_a48cebdddd48a1fa5db300d80ed6bdaa2}\label{class_pcode_inject_library_a48cebdddd48a1fa5db300d80ed6bdaa2}} 
...
\end{center}
\end{figure}
\mbox{\Hypertarget{class_pcode_inject_library_a738666065a924346cf552b1d62c84848}\label{class_pcode_inject_library_a738666065a924346cf552b1d62c84848}} 
...
\mbox{\Hypertarget{class_pcode_inject_library_a8ee8b14330c4a1a686bcecd84dc0c2e9}\label{class_pcode_inject_library_a8ee8b14330c4a1a686bcecd84dc0c2e9}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!callFixupMap@{callFixupMap}}
\index{callFixupMap@{callFixupMap}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\mbox{\Hypertarget{class_pcode_inject_library_a6546a7f92bd290b988efe959e3fd84f6}\label{class_pcode_inject_library_a6546a7f92bd290b988efe959e3fd84f6}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!callFixupNames@{callFixupNames}}
\index{callFixupNames@{callFixupNames}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\mbox{\Hypertarget{class_pcode_inject_library_a5e60d3c9319a18387281404cb92503e3}\label{class_pcode_inject_library_a5e60d3c9319a18387281404cb92503e3}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!callMechFixupMap@{callMechFixupMap}}
\index{callMechFixupMap@{callMechFixupMap}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\mbox{\Hypertarget{class_pcode_inject_library_a082b2a2b26f725dc6bc43224e528664d}\label{class_pcode_inject_library_a082b2a2b26f725dc6bc43224e528664d}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!callMechTarget@{callMechTarget}}
\index{callMechTarget@{callMechTarget}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\mbox{\Hypertarget{class_pcode_inject_library_a7bc738dd5cedca8a28dad33fac7629b6}\label{class_pcode_inject_library_a7bc738dd5cedca8a28dad33fac7629b6}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!callOtherFixupMap@{callOtherFixupMap}}
\index{callOtherFixupMap@{callOtherFixupMap}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\mbox{\Hypertarget{class_pcode_inject_library_aac7dd876176633699593928163eb9336}\label{class_pcode_inject_library_aac7dd876176633699593928163eb9336}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!callOtherTarget@{callOtherTarget}}
\index{callOtherTarget@{callOtherTarget}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\mbox{\Hypertarget{class_pcode_inject_library_a132ab1eb8c759a0cfaa78ad1b25f5b8b}\label{class_pcode_inject_library_a132ab1eb8c759a0cfaa78ad1b25f5b8b}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!glb@{glb}}
\index{glb@{glb}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
The \mbox{\hyperlink{class_architecture}{Architecture}} to which the injection payloads apply. 



Definition at line 162 of file pcodeinject.\+hh.

\mbox{\Hypertarget{class_pcode_inject_library_ab56d641b00776993e15d0349627a8672}\label{class_pcode_inject_library_ab56d641b00776993e15d0349627a8672}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!injection@{injection}}
\index{injection@{injection}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\mbox{\Hypertarget{class_pcode_inject_library_a6c35289813560d4552f2464e1a804bc2}\label{class_pcode_inject_library_a6c35289813560d4552f2464e1a804bc2}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!scriptMap@{scriptMap}}
\index{scriptMap@{scriptMap}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\mbox{\Hypertarget{class_pcode_inject_library_ac78d668f99a551401c0a88ad6ea52a45}\label{class_pcode_inject_library_ac78d668f99a551401c0a88ad6ea52a45}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!scriptNames@{scriptNames}}
\index{scriptNames@{scriptNames}!PcodeInjectLibrary@{PcodeInjectLibrary}}
...
\mbox{\Hypertarget{class_pcode_inject_library_a52091b5829f5085157ec948cd1eef60c}\label{class_pcode_inject_library_a52091b5829f5085157ec948cd1eef60c}} 
\index{PcodeInjectLibrary@{PcodeInjectLibrary}!tempbase@{tempbase}}
\index{tempbase@{tempbase}!PcodeInjectLibrary@{PcodeInjectLibrary}}
